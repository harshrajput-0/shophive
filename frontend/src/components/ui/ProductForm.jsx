...
const inputClass =
  'w-full rounded-lg border border-border-strong bg-transparent p-[13px] text-[15px] text-text outline-none font-inherit placeholder:text-text-secondary focus:border-primary';
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <button
        type="submit"
        disabled={submitting}
        className="mt-2 rounded-[9px] border border-primary bg-primary px-7 py-3.5 text-[14.5px] font-bold text-primary-foreground cursor-pointer disabled:cursor-not-allowed disabled:opacity-60"
      >
