...
const skeletonClass =
  'h-[340px] rounded-[14px] bg-[linear-gradient(90deg,var(--color-bg-secondary)_25%,var(--color-surface-3)_37%,var(--color-bg-secondary)_63%)] bg-[length:400%_100%] animate-shimmer';
  ...
  if (products.length === 0) {
    return (
      <div className="col-span-full rounded-2xl border border-dashed border-border-strong px-7.5 py-17.5 text-center">
        <p className="text-[1.08rem] text-text-secondary">
          {emptyMessage}
        </p>
      </div>
    );
