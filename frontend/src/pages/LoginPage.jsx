...
const inputStyle =
  "p-3 bg-bg-secondary border border-border-stong rounded-[8px] text-text text-4 w-full border-box";
...
export const LoginPage = () => {
  ...
  return (
    <div className="w-105 my-10 mx-auto">
      <h1 className="font-display text-4xl text-text mb-2 text-center">Welcome back</h1>
      ...
      >
        ...
        <Button
          ...
          className={`border-0 ${status === "loading" ? "opacity-50" : "opacity-100"}`}
        >
